...
// Safety checks
console.log(
  "profiles.js loaded. token present?",
  !!token,
  "API_URL:",
  API_URL,
  "profilesGrid found?",
...
function hideLoading() {
  ...
  if (profilesGrid) profilesGrid.style.display = "grid";
}

async function loadProfiles() {
  if (!profilesGrid) {
    console.error(
      'profilesGrid element not found. Make sure your profiles.html contains <div id="profiles-grid"></div>'
    );
    return;
  }
